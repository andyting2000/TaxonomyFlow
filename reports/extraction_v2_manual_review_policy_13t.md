...
- Preserve all conflicting candidates: True
- Choose winner automatically: False
- Blocks auto mapping by default: True
- Conflict group count: 45

## Mapping Candidate Input Contract

- Allowed statuses for #13U: ['auto_mappable_candidate', 'suggest_mapping_only']
- Suggest-only requires confirmation: True
- Blocked statuses: ['manual_review_required', 'blocked_from_mapping', 'reference_only_or_context']
...
- Feature #13U - Manual-review queue UI/API planning before mapping cutover.
